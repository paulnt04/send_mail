...
= Installation
  ...
  ## Right now it is not in gem form, so it cannot be installed using gem or bundler

= Use

  email = SendMail.new(:recipient => 'recipient@test.com', :sender => 'sender@test.com', :subject => 'Test Subject', :body => 'Test Body')
  email.send
